...
namespace Tests
{
    public class StockServiceTests
    {
        ...
        {
            //_stockServices = new StocksService(new StocksRepository());
        }
        ...
        public void CreateBuyOrder_NullBuyOrder_ToBeArgumentNullException()
        {
            ...
            {
                _stockServices.CreateBuyOrder(buyOrder);
            });
            
        }

        [Fact]
        public void CreateBuyOrder_QuantityIsLessThanMinimum_ToBeArgumentException()
        {
            BuyOrderRequest buyOrder = new BuyOrderRequest()
            {
                StockSymbol = "AAPL",
                StockName = "Apple",
                Quantity = 0,
        ...
        public void CreateBuyOrder_QuantityIsGreaterThanMaximum_ToBeArgumentException()
        {
            BuyOrderRequest buyOrder = new BuyOrderRequest()
            {
                StockSymbol = "AAPL",
        ...
        public void CreateBuyOrder_PriceIsLessThanMinimum_ToBeArgumentException()
        {
            BuyOrderRequest buyOrder = new BuyOrderRequest()
            {
                StockSymbol = "AAPL",
        ...
        [Fact]
        public void CreateBuyOrder_PriceIsGreaterThanMaximum_ToBeArgumentException()
        {
            //Arrange
            BuyOrderRequest? buyOrderRequest = new BuyOrderRequest() { StockSymbol = "MSFT", StockName = "Microsoft", Price = 1, Quantity = 100000000 };
        ...
        public void CreateBuyOrder_ValidData_ToBeSuccessful()
        {
            ...
            BuyOrderResponse buyOrderResponseFromCreate = _stockServices.CreateBuyOrder(buyOrderRequest).Result;
        ...
        public void CreateSellOrder_NullSellOrder_ToBeArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() =>
            {
                _stockServices.CreateSellOrder(sellOrderRequest);
            });
        }
        ...
        public void CreateSellOrder_ValidData_ToBeSuccessful()
        {
            ...
            //Act
            SellOrderResponse sellOrderResponseFromCreate = _stockServices.CreateSellOrder(sellOrderRequest).Result;
        ...
        {
            //Act
            List<BuyOrderResponse> buyOrdersFromGet = _stockServices.GetBuyOrders().Result;
        ...
        public void GetAllBuyOrders_WithFewBuyOrders_ToBeSuccessful()
        {
            ...
            {
                BuyOrderResponse buyOrder_response = _stockServices.CreateBuyOrder(buyOrder_request).Result;
                buyOrder_response_list_from_add.Add(buyOrder_response);
            }

            //Act
            List<BuyOrderResponse> buyOrders_list_from_get = _stockServices.GetBuyOrders().Result;
        ...
        {
            //Act
            List<SellOrderResponse> sellOrdersFromGet = _stockServices.GetSellOrders().Result;
        ...
        public void GetAllSellOrders_WithFewSellOrders_ToBeSuccessful()
        {
            ...
            {
                SellOrderResponse sellOrder_response = _stockServices.CreateSellOrder(sellOrder_request).Result;
                sellOrder_response_list_from_add.Add(sellOrder_response);
            }

            //Act
            List<SellOrderResponse> sellOrders_list_from_get = _stockServices.GetSellOrders().Result;
